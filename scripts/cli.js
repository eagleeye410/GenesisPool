...
const contractABI = require("../artifacts/contracts/Genesispool.sol/Genesispool.json").abi;

program
    .name("genesispool-cli")
    .description("CLI tool for Genesispool smart contract")
    .version("1.0.0");
