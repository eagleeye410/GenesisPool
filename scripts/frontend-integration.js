 ...
 * This file demonstrates how to integrate Genesispool with a web frontend
 */

// For React/Vue/Angular applications
export class GenesispoolClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GenesispoolClient(provider, contractAddress);
